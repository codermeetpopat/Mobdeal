            ...
            <div class="row">
                ...
                <div class="col-md-6 login-form-2">
                    <div class="login-logo">
                        <img src="images/logovs.jpeg" alt="OR" />
                    </div>
                    <h3> <b>Registration</b></h3>
                     ...
                     <div class="form-group">
                         ...
                         <asp:TextBox ID="captcha1" runat="server" class="form-control"  placeholder="captcha : *"></asp:TextBox>
                                    </div>
                            <div class="form-group">
                        <asp:Label ID="Label1" runat="server" class="form-control" ForeColor="Red"></asp:Label>
                      </div>
                    <div class="form-group">
                    <asp:TextBox ID="captcha2" runat="server" placeholder=" re-type captcha : *"  class="form-control"></asp:TextBox>
                         <asp:CompareValidator ID="cvconff" runat="server" ControlToCompare="captcha1" 
                                Operator="Equal" ControlToValidate="captcha2" ErrorMessage="Not Match captcha or Conform captcha" Display="Dynamic" Style="color: red">
                            </asp:CompareValidator>
                        </div>
                        <div class="form-group text-center">
